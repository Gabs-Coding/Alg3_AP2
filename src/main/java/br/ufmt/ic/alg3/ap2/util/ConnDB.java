...
public class ConnDB {
    ...
    private ConnDB() {
        ...
        try {
            ...
            String sgbd = config.getProperty("postgresql");
            String host = config.getProperty("localhost");
            Integer port = Integer.valueOf(config.getProperty("5432"));
            String db_name = config.getProperty("PostgreSQL 16");
            String user = config.getProperty("root");
            String password = config.getProperty("123456");
